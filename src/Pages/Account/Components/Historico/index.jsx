...
const Historico = () => {
    ...
    const { data: orders, isFetching} = useFetch(`user_orders/${user.id}`)
                                    ...
                                    return (
                                        <div key={i.order_items_id} className='order_item'>
                                            ...
                                            <div className='order_item_description'>
                                                ...
                                                <p><strong>Tamanho:</strong> <span style={{color: 'red'}}>{i.size}</span></p>
    ...
    return (
        <div className='user_history' style={{padding: '10px', minHeight: '400px'}}>
